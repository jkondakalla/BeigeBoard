...
import { useT, FONT_HEAD, FONT_BODY, FONT_NUM, sourceOf } from '../lib/theme'
        ...
        <div style={{ padding: '20px 28px 28px', overflowY: 'auto' }}>
          {icloudForm ? (
            <div>
              ...
              <p style={{ fontFamily: FONT_HEAD, fontStyle: 'italic', fontSize: 11, color: T.ink2, margin: '0 0 14px', lineHeight: 1.5 }}>
                Use an <strong style={{ color: T.ink }}>app-specific password</strong> — not your Apple ID password.
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 12 }}>
                <input
                  ...
                  style={{
                    ...
                    color: T.ink, fontFamily: FONT_BODY, fontSize: 12,
              ...
              {icloudErr && (
                <p style={{ fontFamily: FONT_BODY, fontSize: 11, color: T.red, margin: '0 0 10px', lineHeight: 1.5 }}>
                  {icloudErr}
                </p>
              )}
              <div style={{ display: 'flex', gap: 8 }}>
                <button onClick={handleIcloudSubmit} disabled={connecting === 'icloud'} className="btn-action" style={{
                  ...
                  background: T.paperDark, border: `1px solid ${T.rule}`,
                  fontFamily: FONT_BODY, fontSize: 12, color: T.ink, cursor: connecting === 'icloud' ? 'wait' : 'pointer',
                }}>
                  {connecting === 'icloud' ? 'Connecting…' : 'Connect iCloud'}
                </button>
                <button onClick={() => { setIcloudForm(false); setIcloudErr(null) }} style={{
                  padding: '9px 14px',
                  background: 'transparent', border: `1px solid ${T.ruleSoft}`,
                  fontFamily: FONT_BODY, fontSize: 12, color: T.ink2, cursor: 'pointer',
                }}>
                  Cancel
                </button>
              </div>
          ...
          {oauthError && (
            <p style={{
              fontFamily: FONT_BODY, fontSize: 11, color: T.red,
